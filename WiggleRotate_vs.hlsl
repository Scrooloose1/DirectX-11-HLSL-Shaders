...
WigglePixelShaderInput main(BasicVertex modelVertex)
{
    WigglePixelShaderInput output; // This is the data the pixel shader requires from this vertex shader
    ...
    // Wiggle effect
    worldPosition.x += sin(modelPosition.y + gWiggle) * 0.5f;
