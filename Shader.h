...
extern ID3D11VertexShader* gFadeTwoTexturesVertexShader;
extern ID3D11PixelShader*  gFadeTwoTexturesPixelShader;
extern ID3D11VertexShader* gAlphaVertexShader;
